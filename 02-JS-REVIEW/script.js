...
const summary = `${title}, a ${pages}-page long book a book, was writter by ${author} and published in ${getYear(
  publicationDate
)}. the book has ${hasMovieAdaptation ? "" : "not"} been adaped as a movie`;
summary;
